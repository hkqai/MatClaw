...
def collate_precursor_batch(dataset_list):
    """Collate batch for precursor prediction (target materials only)."""
    # define the lists
...
def collate_temperature_batch(dataset_list):
    """Collate batch for temperature prediction (target + precursor materials)."""
    # define the lists
    batch_tar_atom_weights = []
    batch_tar_atom_fea = []
    batch_tar_self_fea_idx = []
